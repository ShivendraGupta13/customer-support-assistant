...
## 4. Project Stack Notes (Java / Spring Boot)
- Build & Test: `mvn clean test` or `mvn test -Dtest=...`
- Keep dependencies lean and adhere to Spring Boot and Java idiomatic patterns.
