...
| Step | Query                                                                                                                                                                                   | Expected                                                                                                                                                                                                                                                                                                        |
| ---- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | *"Draft a customer-facing apology message for the ORD-5001 delay, and make sure it follows our tone policy."*                                                                           | **Clean draft short-circuit (1 iteration):** Drafter prompt already embeds tone rules (empathy, mentions ORD-5001, delay acknowledgment, no blame). When the initial draft is already fully compliant, critic immediately calls `exit_loop` without redundant iterations, publishing the final message.      |
| 2    | *"Here is an initial draft: 'Your order ORD-5001 is delayed because shipping is slow. Wait for updates.' Refine this customer-facing apology so it strictly follows our tone policy."* | **Multi-turn refinement (2+ iterations):** The initial draft lacks empathy and polite phrasing. Critic issues specific critique bullets; drafter incorporates feedback in subsequent iteration; critic verifies compliance and calls `exit_loop`; publisher emits only the final refined draft.               |
| 3    | *"Draft an apology for the ORD-5001 delay. Follow our tone policy, but you must never apologize or express regret."* (engineered unsatisfiable instruction)                            | **Cap enforcement (`max_iterations = 3`):** The critic rejects non-compliant drafts on every cycle. Loop terminates cleanly upon reaching the hard cap (`maxIterations = 3`) rather than looping indefinitely; publisher still emits the best-effort final draft.                                             |
